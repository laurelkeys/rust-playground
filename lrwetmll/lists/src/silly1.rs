// https://rust-unofficial.github.io/too-many-lists/infinity-double-single.html
...
// @Note: copied from second.rs, instead of using:
//  |
//  |   use crate::second::List as Stack;
//
// so that we can easily access its private details.
